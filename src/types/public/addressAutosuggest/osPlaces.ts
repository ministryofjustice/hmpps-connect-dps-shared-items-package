export interface OsPlacesQueryResponse {
  header: OsPlacesResponseHeader
  results: OsPlacesQueryResult[]
}

export interface OsPlacesResponseHeader {
  uri: string
  query: string
  offset: number
  totalresults: number
...
export interface OsPlacesQueryResult {
  DPA?: OsPlacesDeliveryPointAddress
  LPI?: OsPlacesLandPropertyIdentifier
}

export interface OsPlacesLandPropertyIdentifier {
  UPRN: number
  ADDRESS: string
  USRN: number
  LPI_KEY: string
...
export interface OsPlacesDeliveryPointAddress {
  UPRN: number
  UDPRN: number
  ADDRESS: string
